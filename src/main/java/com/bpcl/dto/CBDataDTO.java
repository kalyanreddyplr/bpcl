...
public String toString() {
	return "CBDataDTO [planId=" + planId + ", locCode=" + locCode + ", lineNo=" + lineNo + ", batchNo=" + batchNo
			+ ", prodCode=" + prodCode + ", prodName=" + prodName + ", prodSize=" + prodSize + ", packType=" + packType
			+ ", mrpBatchNo=" + mrpBatchNo + ", aggregatedOn=" + aggregatedOn + ", couponStatus=" + couponStatus
			+ ", status=" + status + ", packDetails=" + packDetails + "]";
}
